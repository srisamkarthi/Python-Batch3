    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('blog', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='netzwerkblogApp.blog')),
            ],
            options={
                'ordering': ['post_date'],
            },
        ...
        migrations.AddField(
            model_name='blog',
            name='author',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='netzwerkblogApp.blogauthor'),
        ),
    ]
